...
//        titleLabel.text = "settings.info_subtitle".localized
        ...
        let attrs = [NSAttributedString.Key.font: UIFont.caption, NSAttributedString.Key.foregroundColor: UIColor.themeGray, NSAttributedString.Key.paragraphStyle: paragraphStyle]
        let attrStr = NSAttributedString(string: "settings.info_subtitle".localized, attributes: attrs)
